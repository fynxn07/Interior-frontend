...
function LogoTile({ client, index }) {
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center h-28 sm:h-32 bg-gradient-to-br from-[#fdfcfa] to-[#efe8db] px-5 py-4">
        <img
          src={client.logo}
          alt={client.name}
    ...
    <div className="overflow-hidden relative">
      ...
      >
        {doubled.map((client, i) => (
          <div
            key={`${client.name}-${i}`}
            className="flex items-center justify-center h-24 w-44 p-5 rounded-xl bg-gradient-to-br from-[#fdfcfa] to-[#efe8db] flex-shrink-0 shadow-md shadow-black/25"
          >
            <img
              src={client.logo}
              alt={client.name}
